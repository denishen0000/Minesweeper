...
class Vis {
    ...
    static VisJPanelExtender _jPanel_extender;
    static JFrame _jFrame;
    static boolean _vis_initialized;
    ...
    static void _vis_safe_attempt_initialize() {
        if (!_vis_initialized) {
            _vis_initialized = true;
            ...
            _jPanel_extender = new VisJPanelExtender();
            _jPanel_extender.setPreferredSize(new Dimension(_canvas_get_width_Pixel(), _canvas_height_Pixel));
...
class VisJPanelExtender extends JPanel {
    ...
    public void paintComponent(Graphics paintComponentGraphics) { 
        ...
        while (Vis._buffered_image_graphics == null) {}
        while (Vis._buffered_image == null) {}
        paintComponentGraphics.drawImage(Vis._buffered_image, 0, 0, null);
    }
}
